		  ...
		  <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='post' action='aksi_pembeli.php?act=input'>
                  <div class="form-group">
                      <label for="id_pembeli">no pembeli</label>
                      <input type="number" class="form-control" name="id_pembeli" placeholder="masukkan NO">   
                    </div>
                    <div class="form-group">
                      <label for="nama_pembeli">Nama pembeli</label>
                      <input type="text" class="form-control" name="nama_pembeli" placeholder="masukkan nama">
